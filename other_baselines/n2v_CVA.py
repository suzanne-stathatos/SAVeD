...
def main():
    ...
    FRAMES_DIR = f"{DATA_DIR}/rawframes_baseline_all_flat_symlinks"
    root_path = Path(FRAMES_DIR)

    # create paths for the data
    data_path = Path(root_path)
    train_path = data_path
    val_path = Path(f"{DATA_DIR}/rawframes_baseline_all_flat_symlinks") / "benign_263b86b85a58f270_000030.png"
    ...
    results_path = f"{RESULTS_DIR}/n2v_CVA_results" 
