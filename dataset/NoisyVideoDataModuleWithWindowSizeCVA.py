...
from dataset.NoisyVideoDatasetWithWindowSizeCVA import NoisyVideoDatasetWithWindowSizeCVA
from typing import Optional

class NoisyVideoDataModuleWithWindowSizeCVA(pl.LightningDataModule):
    def __init__(
        self,
        data_dir: str,
        transform=None,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage == "fit" or stage is None:
            full_dataset = NoisyVideoDatasetWithWindowSizeCVA(
