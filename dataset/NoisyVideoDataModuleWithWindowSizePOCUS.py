...
from dataset.NoisyVideoDatasetWithWindowSizePOCUS import NoisyVideoDatasetWithWindowSizePOCUS
from typing import Optional

class NoisyVideoDataModuleWithWindowSizePOCUS(pl.LightningDataModule):
    def __init__(
        self,
        data_dir: str,
        transform=None,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage == "fit" or stage is None:
            full_dataset = NoisyVideoDatasetWithWindowSizePOCUS(
