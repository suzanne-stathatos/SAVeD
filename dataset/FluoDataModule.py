...
from dataset.FluoDataset import FluoDataset
from typing import Optional

class FluoDataModule(pl.LightningDataModule):
    def __init__(
        self,
        data_dir: str,  
        transform=None,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage == "fit" or stage is None:
            ...
            print(f"Fluo training size: {len(self.train_dataset)}")
